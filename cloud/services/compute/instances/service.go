...
type instancesInterface interface {
	...
	Insert(ctx context.Context, key *cloud.MetaKey, obj *compute.Instance) error
	Delete(ctx context.Context, key *cloud.MetaKey) error
}

type instancegroupsInterface interface {
	AddInstances(ctx context.Context, key *cloud.MetaKey, req *compute.InstanceGroupsAddInstancesRequest) error
	ListInstances(ctx context.Context, key *cloud.MetaKey, req *compute.InstanceGroupsListInstancesRequest, fl *cloud.Filter) ([]*compute.InstanceWithNamedPorts, error)
	RemoveInstances(ctx context.Context, key *cloud.MetaKey, req *compute.InstanceGroupsRemoveInstancesRequest) error
}
